  ...
  Widget build(BuildContext context) {
    ...
    switch (selectedIndex) {
      case 0:
        ...
        break;
      case 1:
        page = FavoritesPage(); //temporary page with a cross in it
        break;
      default:
            ...
            children: [
              SafeArea(
                child: NavigationRail(
                  extended: constraints.maxWidth >= 600, //extended: true shows label, only true when width is greater than
                  destinations: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: page, //this here is saying what page to display when
                ),
              ),
            ],
          ),
